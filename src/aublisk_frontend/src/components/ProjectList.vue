<template>
    <div v-for="(project, idx) in list" class="col-md-6 col-xl-3">
        <div class="freelancer-style1 bdrs12 bdr1 hover-box-shadow">
            ...
            <div class="details mt-4">
                ...
                <h4><small class="text fz14 me-3">Budget</small>{{ wallet_balance[idx] }} {{ token[project.icrc_token_address].symbol }}</h4>
                <div class="d-grid mt15">
                    <a href="page-freelancer-single.html" class="ud-btn btn-thm-border bdrs12 default-box-shadow1">Send
